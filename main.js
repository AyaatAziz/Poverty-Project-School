...
function submit()
{
    ...
    var name_21= document.getElementById("name_of_the_student_21").value;
    var name_22= document.getElementById("name_of_the_student_22").value;
    var name_23= document.getElementById("name_of_the_student_23").value;
    var name_24= document.getElementById("name_of_the_student_24").value;
    var name_25= document.getElementById("name_of_the_student_25").value;
    var name_26= document.getElementById("name_of_the_student_26").value;
    var name_27= document.getElementById("name_of_the_student_27").value;
    ...
    name_of_the_student_array.push(name_21)
    name_of_the_student_array.push(name_22)
    name_of_the_student_array.push(name_23)
    name_of_the_student_array.push(name_24)
    name_of_the_student_array.push(name_25)
    name_of_the_student_array.push(name_26)
    name_of_the_student_array.push(name_27)
